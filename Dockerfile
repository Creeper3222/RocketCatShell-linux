...
RUN chmod +x /usr/local/bin/rocketcat-entrypoint.sh \
    && mkdir -p /app/config/plugins_config /app/data/bots /app/data/plugin_data /app/logs

EXPOSE 5751

VOLUME ["/app/config", "/app/data/bots", "/app/data/plugins", "/app/data/plugin_data", "/app/logs"]
